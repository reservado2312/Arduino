...
// Definições do display MD_MAX72xx
...
MD_MAX72XX display = MD_MAX72XX(HARDWARE_TYPE, DATA_PIN, CLK_PIN, CS_PIN);
...
void setup() {
  ...
  display.begin();
  display.setIntensity(0);  // Ajusta a intensidade do display
  display.clear();
