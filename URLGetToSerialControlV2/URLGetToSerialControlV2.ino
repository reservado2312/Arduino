...
void getMenssagem()
{
    ...
    if (server.hasArg("data")) {
      ...
      lcd.clear();
      // Imprime a mensagem
      // Em breve função scroll da menssagem na linha 2
      lcd.setCursor(0,0);
      lcd.print("Menssagem:");
      lcd.setCursor(0,1);
      lcd.print(data);
...
void setup() {
  ...
  server.on("/", HTTP_GET, []() {
    ...
    html += "</form>";
    html += "<h3>Imagem EspCam32</h3>";
    html += "<div class='embed-responsive embed-responsive-1by1'>";
    html += "<iframe class='embed-responsive-item' src='http://192.168.1.24:81/stream'></iframe>";
    html += "</div>";
